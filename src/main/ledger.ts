...
export function createTxn(db: Database.Database, p: NewTxn): void {
...
function getTxn(db: Database.Database, id: number): TxnDbRow {
  const row = db
...
export function updateTxn(db: Database.Database, p: TxnUpdate): void {
  validateCommon(p.date, p.amountCents)
...
export function deleteTxn(db: Database.Database, id: number): void {
...
export function setTxnCleared(db: Database.Database, id: number, cleared: boolean): void {
